...
app = DjangoDash('SimpleExample',external_stylesheets=[dbc.themes.SOLAR])
...
def preprare_data(competitions=competitions):
        folder_path = 'django_dash/datasets/'
...
app.layout = html.Div(
    [
    dbc.Row(
        dbc.Col(html.H1("Players Rating Dashboard", style={"color": "black", "fontSize": 65, "textAlign": "center", }), )),
    dbc.Row(
